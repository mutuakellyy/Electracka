...
$query = $dbconnect->prepare("SELECT firstname, surname, contact FROM user WHERE emailaddress = ?");
...
<form method="POST" action="update_profile.php">
    ...
    <label>Phone:</label>
    <input type="text" name="phone" value="<?= htmlspecialchars($user['contact']) ?>" required><br><br>
